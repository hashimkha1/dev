# Generated by Django 3.2.6 on 2023-02-18 16:35
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('category', models.CharField(choices=[('Contributions', 'Contributions'), ('Donations', 'Donations'), ('Business', 'Business'), ('Stocks', 'Stocks'), ('Other', 'Other')], max_length=25)),
                ...
                ('sender', models.ForeignKey(limit_choices_to=models.Q(('sub_category', 6), ('is_superuser', True), _connector='OR'), on_delete=django.db.models.deletion.CASCADE, related_name='dc_inflows', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['transaction_date'],
            },

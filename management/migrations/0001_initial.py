# Generated by Django 3.2.6 on 2023-02-18 16:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(blank=True, default=1, limit_choices_to=models.Q(('is_employee', True), ('is_admin', True), ('is_superuser', True), _connector='OR'), null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='creator', to=settings.AUTH_USER_MODEL, verbose_name='creator')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('laptop_saving', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='management.laptopsaving')),
                ('loan', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='management.loan')),
                ('retirement_package', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='management.retirementpackage')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('category', models.CharField(choices=[('Table', 'Table'), ('Api_Integration', 'Api_Integration'), ('View', 'View'), ('Diagram', 'Diagram'), ('Templates', 'Templates'), ('Forms', 'Forms'), ('Other', 'Other')], default='Other', max_length=25)),
                ('task', models.CharField(choices=[('creation', 'creation'), ('Testing', 'Testing'), ('dictionary', 'dictionary'), ('diagram', 'diagram'), ('Other', 'Other')], default='Other', max_length=25)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('qty', models.CharField(max_length=50)),
                ('duration', models.IntegerField(default=4)),
                ('comment', models.TextField()),
                ('is_active', models.BooleanField(default=True)),
                ('requirement', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='management.requirement')),
            ],
        ),
        migrations.CreateModel(
            name='Advertisement',

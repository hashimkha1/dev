    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('retirement_package', models.DecimalField(decimal_places=2, default=0.0, max_digits=10)),
                ('training_loan', models.DecimalField(decimal_places=2, default=0.0, max_digits=10)),
                ...
                ('laptop_service', models.DecimalField(decimal_places=2, default=0.0, max_digits=10)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(

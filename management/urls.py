...
urlpatterns = [
    ...
    path(
        "companyagenda/updatelinks",
        views.updatelinks_companyagenda,
        name="companyagenda-updatelinks",
    ),
    ...
    path(
        "policy/<int:pk>/update/",
        views.PolicyUpdateView.as_view(
            template_name="management/departments/hr/policy_form.html"
        ),
        name="policy-update",
    ),
    ...
    path(
        "usertask/<int:pk>/update/", UsertaskUpdateView.as_view(), name="userupdatetask"
    ),
    ...
    path(
        "department/<int:pk>/",
        DepartmentUpdateView.as_view(template_name="management/tag_form.html"),
    ...
    path(
        ...
        RequirementUpdateView.as_view(
            template_name="management/doc_templates/requirement_form.html"
        ),

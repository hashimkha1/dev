# Generated by Django 3.2.6 on 2022-03-05 04:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('midle', models.CharField(blank=True, max_length=100, null=True)),
                ...
                ('link', models.CharField(blank=True, max_length=100, null=True)),
                ('user', models.ForeignKey(default=999, on_delete=django.db.models.deletion.CASCADE, related_name='uploaded_interview', to=settings.AUTH_USER_MODEL)),
            ],
            options={

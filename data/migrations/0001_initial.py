# Generated by Django 3.2.6 on 2023-04-06 07:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('questioner', models.ForeignKey(blank=True, limit_choices_to=models.Q(('is_client', True), ('is_employee', True), ('is_superuser', True), _connector='OR'), null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='questioner', to=settings.AUTH_USER_MODEL, verbose_name='questioner')),
            ],
            options={

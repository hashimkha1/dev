# Generated by Django 3.2.6 on 2022-03-04 21:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(default=999, on_delete=django.db.models.deletion.RESTRICT, related_name='client_interview', to=settings.AUTH_USER_MODEL)),
            ],
            options={

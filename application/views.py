...
from.models import Balancesheet_category,Balancesheet_entry,BalanceSheet_Summary,exception_user
import logging
...
def exception_list(request):
    model = exception_user
    return render(request,"application/exception_List.html")

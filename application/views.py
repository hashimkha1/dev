...
from.models import Balancesheet_category,Balancesheet_entry,BalanceSheet_Summary, WCAGScodaWebsite
import logging
...
def wcag_list_view(request):
    wcaglists=WCAGScodaWebsite.objects.all().order_by("updated_at")

...
from .models import Balancesheet_categories,Balancesheet_category,Balancesheet_entry,BalanceSheet_Summary,InvestmentStrat
...
admin.site.register(InvestmentStrat)

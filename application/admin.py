...
from .models import Balancesheet_categories,Balancesheet_category,Balancesheet_entry,BalanceSheet_Summary,WCAGScodaWebsite
...
admin.site.register(WCAGScodaWebsite)

...
from .models import Balancesheet_categories,Balancesheet_category,Balancesheet_entry,BalanceSheet_Summary,receiver_asset
...
admin.site.register(receiver_asset)

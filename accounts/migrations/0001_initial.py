# Generated by Django 3.2.6 on 2022-07-26 20:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('emp_name', models.ForeignKey(default=1, limit_choices_to={'is_active': True, 'is_employee': True}, on_delete=django.db.models.deletion.RESTRICT, related_name='employee_name', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['login_date'],
            },

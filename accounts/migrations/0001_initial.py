# Generated by Django 3.2.6 on 2022-06-10 04:15
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sub_category', models.IntegerField(choices=[(1, 'Client Or Customer'), (2, 'Student')], default=999)),
                ...
                ('is_applicant', models.BooleanField(default=True, verbose_name='Is applicant')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clientname', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='clientname', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['login_date'],
            },
